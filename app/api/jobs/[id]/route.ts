...
const updateJobSchema = z.object({
  ...
  pageColor: z.union([z.nativeEnum(PageColorType), z.literal('None')]).optional(),
  pageColorOther: z.string().optional(),
  bookSize: z.union([z.nativeEnum(BookSizeType), z.literal('None')]).optional(),
  ...
  plateSize: z.union([z.nativeEnum(PlateSizeType), z.literal('None')]).optional(),
  plateSizeOther: z.string().optional(),
  machineId: z.string().optional(),
  laminationThermal: z.union([z.nativeEnum(LaminationType), z.literal('None')]).optional(),
  normal: z.union([z.nativeEnum(NormalType), z.literal('None')]).optional(),
  folding: z.boolean().optional(),
  binding: z.union([z.nativeEnum(BindingType), z.literal('None')]).optional(),
  bindingOther: z.string().optional(),
  stitch: z.union([z.nativeEnum(StitchType), z.literal('None')]).optional(),
